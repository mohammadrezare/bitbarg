            ...
            <form action="{{route('tasks.update', $task->id)}}" method="post">
                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-8">
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" value="{{$task->title}}" class="form-control" id="exampleFormControlInput1"
                               maxlength="400" required>
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlTextarea1" class="form-label">Description</label>
                        <textarea class="form-control" name="description" id="exampleFormControlTextarea1" rows="3"
                                  maxlength="1200" required>{{$task->description}}</textarea>
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlTextarea1" class="form-label">Creator</label>
                        <input class="form-control" type="text" value="{{$task->user->name}}" readonly>
                    </div>
                    <div class="mb-3">
                        ...
                        <input class="form-control" name="datetime" type="datetime-local"
                               value="{{str_replace(' ', 'T', $task->datetime)}}">
                    </div>
                    <div class="mb-3">
